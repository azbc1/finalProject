...
import com.esprit.credit.repository.CreditRequestRepository;
import com.esprit.credit.repository.InsuranceRepository;
...
//mapping
	    private Credit mapCreditFromCreditRequest(CreditRequest creditRequest) {
	       ...
	       // credit.setCreditStatus(CreditRequestStatus.CREATED);
